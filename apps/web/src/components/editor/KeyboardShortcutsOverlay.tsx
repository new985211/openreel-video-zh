...
> = ({ isOpen, onClose }) => {
  ...
  const handleShortcutCapture = useCallback(
    (e: React.KeyboardEvent, shortcutId: string) => {
      ...
      if (conflict) {
        alert(
          t('keyboard.conflict', { name: conflict.name }),
        );
        return;
      }
  ...
  const handleResetAll = () => {
    if (confirm(t('keyboard.resetConfirm'))) {
        ...
        <div className="flex items-center gap-3 p-4 border-b border-border">
          <div className="flex-1 relative">
            ...
            <Input
              ...
              placeholder={t('keyboard.searchShortcuts')}
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-6">
                      ...
                      <div className="flex items-center gap-2">
                        {editingId === shortcut.id ? (
                          <input
                            ...
                            placeholder={t('keyboard.clickToCustomize')}
                        ...
                        {shortcut.currentKey !== shortcut.defaultKey && (
                          <button
                            ...
                            title={t('keyboard.resetToDefault')}
                          >
                            <RotateCcw size={12} />
                          </button>
                        )}
          ...
          {filteredShortcuts.length === 0 && (
            <div className="text-center py-8 text-text-muted">
              ...
              <p className="text-sm">{t('keyboard.noShortcuts')}</p>
            </div>
          )}
        </div>
