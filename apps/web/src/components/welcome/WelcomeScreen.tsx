...
const FORMAT_OPTIONS: FormatOption[] = [
  {
    id: "vertical",
    preset: "tiktok",
    label: "welcome.vertical.label",
    description: "welcome.vertical.description",
  ...
  },
  {
    ...
    label: "welcome.horizontal.label",
    description: "welcome.horizontal.description",
  ...
  },
  {
    ...
    label: "welcome.square.label",
    description: "welcome.square.description",
...
export const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ initialTab }) => {
  ...
  const newProjectNames: Record<string, string> = {
    vertical: t('welcome.newVerticalVideo'),
    horizontal: t('welcome.newHorizontalVideo'),
    square: t('welcome.newSquareVideo'),
  };

  const handleCreateProject = useCallback(
    (option: FormatOption) => {
      const preset = SOCIAL_MEDIA_PRESETS[option.preset];
      createNewProject(newProjectNames[option.id] || t('welcome.newProject'), {
        width: preset.width,
